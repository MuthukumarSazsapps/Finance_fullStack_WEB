...
export default function SupplierForm({ data, isEdit = false }: { data?: any; isEdit?: boolean }) {
  ...
  const renderCustomerInfo: renderProbs = (control, getValues, errors, register, setValue) => {
    return (
      <FormGroup
        title="Opening Balance Settings"
        description="Opening Balance Update"
        className="pt-1 @2xl:pt-1 @3xl:grid-cols-6 @3xl:pt-2"
        ...
        <Input
          ...
          register={register}
          textonly={true}
          placeholder="Puchase Opening Balance As on - "
          error={errors.GuarantorFatherName?.message}
        />
      </FormGroup>
    );
