...
import AuthWrapperFive from 'common/auth-layout/auth-wrapper-five';
import WaveLongShape from 'components/shape/wave-long';

export default function Otp5() {
  return (
    <AuthWrapperFive
      ...
      pageimg={
        <div className="relative mx-auto aspect-[1/1.015] w-[540px] xl:w-[600px] 2xl:w-[636px]">
          <img
            src={'https://isomorphic-furyroad.s3.amazonaws.com/public/auth/sign-in-thumb5.png'}
