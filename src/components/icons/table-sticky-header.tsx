...
export default function TableStickyHeaderIcon({ ...props }: React.SVGProps<SVGSVGElement>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="none" {...props}>
      ...
      />
      <path fill="#8379C1" d="M3.84 3.164H1.074a.781.781 0 0 0-.781.781v2.766H3.84V3.164Z" />
      <path
        stroke="currentColor"
        strokeLinecap="round"
