...
export default function ArrowBothDirectionIcon({ ...props }: React.SVGProps<SVGSVGElement>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="none" {...props}>
      ...
      />
      <path fill="#8ABA18" d="M9.184 8.33V4.996h4.986V3.672l2.99 2.99-2.99 2.991V8.331H9.184Z" />
    </svg>
  );
}
