...
export default function ExpenseIcon({ ...props }: React.SVGProps<SVGSVGElement>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="512" height="512" viewBox="0 0 60 60" {...props}>
      <path
        fill="#d6dbe3"
      ...
      />
      <path fill="#2783ec" d="M12 48a1 1 0 0 1-1-1v-4a1 1 0 0 1 2 0v4a1 1 0 0 1-1 1z" />
      <path fill="#31b791" d="M16 48a1 1 0 0 1-1-1v-8a1 1 0 0 1 2 0v8a1 1 0 0 1-1 1z" />
      <path fill="#8991a0" d="M21 48H8a1 1 0 0 1-1-1V37a1 1 0 0 1 2 0v9h12a1 1 0 0 1 0 2z" />
      <g fill="#b9bfcc">
